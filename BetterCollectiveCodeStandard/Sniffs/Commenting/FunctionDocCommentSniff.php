<?php
/**
 * BetterCollectiveCodeStandard_Sniffs_Commenting_FunctionDocCommentSniff
 *
 * PHP version 5
 *
 * @category  Commenting
 ...
 */
class BetterCollectiveCodeStandard_Sniffs_Commenting_FunctionDocCommentSniff implements PHP_CodeSniffer_Sniff
{
