<?php
/**
 * BetterCollectiveCodeStandard_Sniffs_Scope_AlwaysReturnSniff.
 *
 * PHP version 5
 *
 * @category  Scope
 ...
 */
class BetterCollectiveCodeStandard_Sniffs_Scope_AlwaysReturnSniff implements PHP_CodeSniffer_Sniff
{
