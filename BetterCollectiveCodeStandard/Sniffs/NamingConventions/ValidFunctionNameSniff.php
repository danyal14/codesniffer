<?php
/**
 * BetterCollectiveCodeStandard_Sniffs_NamingConventions_ValidFunctionNameSniff.
 *
 * PHP version 5
 *
 ...
 */
class BetterCollectiveCodeStandard_Sniffs_NamingConventions_ValidFunctionNameSniff implements PHP_CodeSniffer_Sniff
{
    /**
